...
router.get('/getProfile', user_middleware_1.default, user_controller_1.userController.getProfile);
router.post("/logout", user_middleware_1.default, user_controller_1.userController.signOut);
router.put('/updateProfile/:id', user_middleware_1.default, user_controller_1.userController.updateProfile);
